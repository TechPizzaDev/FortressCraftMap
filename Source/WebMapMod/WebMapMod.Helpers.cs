...
namespace TechPizza.WebMapMod
{
    public partial class WebMapMod
    {
        ...
        {
            if (entry.isMultiBlockMachine && entry.PickReplacement != null)
            {
        ...
        //
        //    int copyWidth = segmentTexture.width; // (int)Math.Floor(segmentTexture.width * scale);
        //    int copyHeight = segmentTexture.height; // (int)Math.Floor(segmentTexture.height * scale);
        //    
